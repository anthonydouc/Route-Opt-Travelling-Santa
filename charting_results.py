...
from data import get_data, get_node_positions, load_submission
...
path = load_submission('test')

# TODO summarise the path length distribution. May need to be seperated 
...
#f1.scatter(x=pX, y=pY, size=0.3, color='#0077b6')
